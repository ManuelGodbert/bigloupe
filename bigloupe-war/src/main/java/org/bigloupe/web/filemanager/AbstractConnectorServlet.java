...
import org.bigloupe.web.filemanager.command.AbstractCommand;
import org.bigloupe.web.filemanager.command.ContentCommand;
import org.bigloupe.web.filemanager.command.OpenCommand;
...
public abstract class AbstractConnectorServlet extends HttpServlet {
	...
	protected Class<AbstractCommand> getCommandClassDefault(String commandName) {
		String className = AbstractConnectorServlet.class.getPackage().getName() + ".command." + StringUtils.capitalize(commandName) + "Command";
	...
	protected Class<AbstractCommand> getCommandClassOverride(String commandName) {
		String className = AbstractConnectorServlet.class.getPackage().getName() + ".command." + StringUtils.capitalize(commandName) + "CommandOverride";
		Class<AbstractCommand> clazz = null;
		try {
			clazz = (Class<AbstractCommand>) Class.forName(className);
		} catch (ClassNotFoundException e) {
