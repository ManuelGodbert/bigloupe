...
public class SwingTerminal extends Terminal {
    ...
    protected GruntConsoleTextArea gruntConsole;

    public SwingTerminal(GruntConsoleTextArea console) {
        this.gruntConsole = console;
    }
