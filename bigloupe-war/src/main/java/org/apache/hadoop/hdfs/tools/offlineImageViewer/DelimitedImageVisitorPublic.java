 ...
 * constructor.
 */
public class DelimitedImageVisitorPublic extends TextWriterImageVisitor {
  ...
  public DelimitedImageVisitorPublic(String filename) throws IOException {
    this(filename, false);
  }

  public DelimitedImageVisitorPublic(String outputFile, boolean printToScreen) 
                                                           throws IOException {
