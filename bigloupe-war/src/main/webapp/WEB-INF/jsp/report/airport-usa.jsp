...
<div class="row">
	<div class="page-header">
		<h3>
			Airports<small>&nbsp;Drag to rotate the origin</small>
		</h3>
...
<script type="text/javascript">
	...
	var projection = d3.geo.azimuthal().mode("equidistant").origin([ -98, 38 ])
			.scale(1400).translate([ 640, 360 ]);
	...
	d3.json("${request.contextPath}/data/json/USA.geo.json", function(collection) {
...
/*  	d3
			.csv(
					...
					function(flights) {
						...
						d3
								.csv(
										"${request.contextPath}/data/csv/airports-usa.csv",
										function(airports) {
