...
<%@page import="org.bigloupe.web.controller.AbstractSchedulerController"%>
	...
	<div class="navbar-inner">
		<div class="container">
			...
			<div class="nav-collapse">
				...
				<c:if test="${fn:length(applicationScope.SCHEDULER.jobExecutorManager.executingJobs) gt 0}">
					<% 
					InitializeScheduler scheduler = (InitializeScheduler)application.getAttribute(AbstractSchedulerController.SCHEDULER);
					Collection<ExecutingJobAndInstance> executing = scheduler.getJobExecutorManager().getExecutingJobs();
					Iterator<ExecutingJobAndInstance> executingEntrySet = executing.iterator();
					ExecutingJobAndInstance executingJobAndInstance = executingEntrySet.next();
					%>
					<span id="jobRunning"></span><i class="icon-heart"></i></span><a href="${request.contextPath}/scheduler/jobDetail.html?id=<%= executingJobAndInstance.getScheduledJob().getId() %>&logs">#${fn:length(applicationScope.SCHEDULER.jobExecutorManager.executingJobs)} jobs is running</a>
