...
public final class Autocompleter {
	...
	public Autocompleter(String autoCompleteDir) throws IOException {
		this.autoCompleteDirectory = FSDirectory
				.open(new File(autoCompleteDir));
	...
	public List<String> suggestTermsFor(String term) throws IOException {
		...
		// Sort sort = new Sort(SortField.FIELD_SCORE, true);
	...
	public static void main(String[] args) throws Exception {
		...
		Autocompleter autocomplete = new Autocompleter("/indexes/autocomplete");
		// run this to re-index from the current index, shouldn't need to do
		// this very often
		autocomplete.reIndex(FSDirectory.open(new File("/indexes/autocomplete"), null),
		 "content");
