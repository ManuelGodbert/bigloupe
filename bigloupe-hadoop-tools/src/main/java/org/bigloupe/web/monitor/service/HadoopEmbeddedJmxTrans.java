 ...
 * Use JMXTrans Embedded (don't support JMX queries on remote server)
 * 
 * @author bigloupe
 * 
 */
@Service
public class HadoopEmbeddedJmxTrans implements InitializingBean, ResourceLoaderAware {
	...
	private static Logger logger = LoggerFactory.getLogger(HadoopEmbeddedJmxTrans.class);
