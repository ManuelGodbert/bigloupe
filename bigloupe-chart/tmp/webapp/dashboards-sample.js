var graphite_url = "http://localhost:9090/graphite";  // enter your graphite url, e.g. http://your.graphite.com
//var graphite_url = "demo"; 

var dashboards = 
[
  { "name": "KARMA Qualification Hadoop cluster ",  // give your dashboard a name (required!)
    ...
    [
      {
        "alias": "Chart 1",  // display name for this metric
        "target": "sumSeries(sample)",  // enter your graphite barebone target expression here
	  ...
	  {
        "alias": "The parallel object scavenger",  // display name for this metric
        "target": "servers.lh-hadoopkarmaqua-st_france_airfrance_fr_8005.heap.HeapMemoryUsage_committed",  
        "description": "Heap Memory Usage Committed",  // enter your metric description here
		"renderer": "line",
        //"summary": "sum",  // available options: [sum|min|max|avg|last|<function>]
      }
      // {
