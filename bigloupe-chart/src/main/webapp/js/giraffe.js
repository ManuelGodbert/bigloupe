...
generateDataURL = function(targets, annotator_target) {
  ...
  return "" + graphite_url + "/render.json?from=-" + period + "minutes&" + data_targets + annotator_target + "&format=json&jsonp=?";
};
...
generateEventsURL = function(event_tags) {
  ...
  return "" + graphite_url + "/events.json/get_data?from=-" + period + "minutes" + tags + jsonp;
};
